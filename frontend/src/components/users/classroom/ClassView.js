...
export const ClassView = props => {
                                    ...
                                    const indexOfFirstList =
                                      indexOfLastList - postPerPage;
                                    const currentList = classList.slice(
                                      indexOfFirstList,
                                      indexOfLastList
                                    );
                                    // Change page
                                                        ...
                                                        <Tooltip
                                                          title={
                                                            data
                                                              ...
                                                              >
                                                                {data.class_description.substring(
                                                                  0
                                                                )}
                                                              </Typography>
                                                            ) : (
